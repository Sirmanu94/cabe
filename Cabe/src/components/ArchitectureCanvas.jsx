...
// Dentro il tuo componente RealModel o PlaceholderVilla:
useFrame(() => {
  if (modelRef.current) {
    // ESTRAI IL VALORE DA FRAMER MOTION USANDO .get()
    const currentScroll = scrollProgress.get(); 
    
    // Ora puoi usarlo per ruotare o muovere il 3D
    modelRef.current.rotation.y = currentScroll * Math.PI * 2;
  }
});
